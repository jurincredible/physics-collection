...
Hindamine: Tikkudest kangkaalu ehitamise idee --- 2 p. Oletus, et tikuväävli masskeskme asukoht ühtib tiku puidust osa otspunktiga --- 1 p. Tasakaalupunkti otsitakse tiku terava serva peal (mitte tiku lapiku külje peal) --- 1 p. Mõõtmisteks vajaliku katseskeemi joonistamine paberile --- 1 p. Tiku osade pikkuste mõõtmine tiku laiuste abil --- 2 p. Matemaatilised teisendused --- 3 p. (kui õpilane avaldab kangi seadusest ainult m/M , siis saab teisenduste eest 1 p.) Kordusmõõtmised (vähemalt 3 korda) --- 1 p. Tulemus vahemikus 15 \% $-$ 25 \% --- 1 p.

Märkus: Kui lahendaja kasutab mõõtejoonlauda, saab ülesande lahenduse eest maksimaalselt 9 punkti.
\probend
